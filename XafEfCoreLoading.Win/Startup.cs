...
public class ApplicationBuilder : IDesignTimeApplicationFactory {
    public static WinApplication BuildApplication(string connectionString) {
        ...
        builder.UseApplication<XafEfCoreLoadingWindowsFormsApplication>();
        builder.Modules
            .AddCloning()
            ...
            .Add<XafEfCoreLoadingWinModule>();
        builder.ObjectSpaceProviders
            .AddEFCore(options => options.PreFetchReferenceProperties())
                .WithDbContext<XafEfCoreLoading.Module.BusinessObjects.XafEfCoreLoadingEFCoreDbContext>((application, options) => {
